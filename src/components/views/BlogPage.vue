      ...
      <div class="blogDetail-all" v-if="article.id">
        ...
        <div class="blogDetail-date">
          <div style="text-align: center ">
            ...
            <span class="pc-ishide">发表于 </span><span >{{article.dateb}}</span> |
          ...
          <div class="pre-next-wrap">
                   <span v-if="onBlog!=null" class="pre-wrap" @click="$router.push({path:'/BlogDetail', query:{id:onBlog.id}})">
                     <i class="el-icon-arrow-left"></i>
                     {{onBlog.title}}
                      <!--<router-link  class="detail-type"  :to="{path:'/BlogDetail',query:{id:onBlog.id}}"  v-html="onBlog.title"></router-link>-->
                   </span>
                   <span   v-if="nexBlog!=null" class="next-wrap" @click="$router.push({path:'/BlogDetail', query:{id:nexBlog.id}})">
    ...
    export default {
      ...
      methods:{
        getArticleData(id){
          ...
          this.onBlog={};
          if(id){
            this.$axios.get('/api/blog/pages/'+id,null)
              .then(res=>{
